...
In this section, code blocks are tangled to ~lisp/ar-nix.el~.
This is required in ~init.el~ using the following code block.
#+begin_src emacs-lisp :padline no :tangle init.el
(require 'ar-nix)
#+end_src
...
In this section, code blocks are tangled to ~lisp/ar-lua.el~.
This is required in ~init.el~ using the following code block.
#+begin_src emacs-lisp :padline no :tangle init.el
(require 'ar-lua)
#+end_src
...
*** TODO Helper: spell check in ~TeX~ with ~jinx~
#+begin_src emacs-lisp
