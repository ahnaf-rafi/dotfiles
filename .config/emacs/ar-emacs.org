...
*** DOC The ~ar-latex-funcs.el~ library
:PROPERTIES:
:header-args:emacs-lisp: :tangle lisp/ar-latex-funcs.el :mkdirp yes
:END:

In this section, code blocks are tangled to ~lisp/ar-latex-funcs.el~.
This is required in ~init.el~ using the following code block.

#+begin_src emacs-lisp
;;; ar-latex-funcs.el --- -*- lexical-binding: t; -*-
...
(provide 'ar-latex-funcs)
;;; ar-latex-funcs.el ends here
#+end_src
...
*** DOC Helpers: compiler functions
#+begin_src emacs-lisp
